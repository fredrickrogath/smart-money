      ...
      children: [
          ...
          child: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                  colors: [Color(0xff583101),Color(0xff8B5E34),
                  ],
        ...
        ClipPath(
          child: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                  colors: [Color(0xffFFEDD8),Color(0xff583101)
                  ],
                  begin: FractionalOffset(0.0, 0.0),
                  end: FractionalOffset(1.0, 0.0),
                  stops: [0.0, 1.0],
        ...
        ClipPath(
          child: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                  colors: [Color(0xff8B5E34),Color(0xff583101),
                  ],
                  begin: FractionalOffset(0.0, 0.0),
                  end: FractionalOffset(1.0, 0.0),
                  stops: [0.0, 1.0],
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(width: 5, color: const Color(0xFFBC8A5F)),
                ),
                child: Icon(
                  _icon,
