            ...
            SizedBox(
                ...
                child: Card(elevation: 2.0,
                    child: Center(
                        child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: const [Text('Remainig to spent'), Text('Tsh 1,230,000')],
                )))),
          ],
        ),
        Row(
            ...
            SizedBox(
                ...
                child: Card(elevation: 2.0,
                    child: Center(
                        child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: const [Text('Total expenditure'), Text('Tsh 730,000')],
                )))),
            SizedBox(
                height: 70,
                width: 180,
                child: Card(elevation: 2.0,
                    child: Center(
                        child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: const [Text('Total budgeted'), Text('Tsh 1,230,000')],
                )))),
          ],
        ),
        ...
        SizedBox(
                ...
                child: Card(elevation: 2.0,
                    child: Center(
                        child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: const [Text('Net disposable income'), Text('Tsh 1,230,000')],
                )))),
